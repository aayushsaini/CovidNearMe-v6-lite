...
function chart1(final_place) {
    ...
    var deaths = 0;
    var recovered = 0;
    fetch("./plotting/district_count.json?ver=3.007")
        .then(function (resp) {
            return resp.json();
        })
        .then(function (data) {
...
function chart2(final_state) {
    ...
    var deaths = 0;
    var recovered = 0;
    fetch("./plotting/state_count.json?ver=3.07")
        .then(function (resp) {
            return resp.json();
        })
        .then(function (data) {
...
function chart3() {
    ...
    var deaths = 0;
    var recovered = 0;
    fetch("./plotting/india.json?ver=3.07")
        .then(function (resp) {
            return resp.json();
        })
        .then(function (data) {
...
async function get_data() {
    const response = fetch('./plotting/analytics_aoi_dw.csv?ver=3.07');
    ...
    const response2 = fetch('./plotting/state_count.csv?ver=3.07');
